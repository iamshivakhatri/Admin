...
export const ColorForm = ({ initialData }: ColorFormProps) => {
    ...
    const onSubmit = async (data: ColorFormValues) => {
        ...
        try {
            ...
            console.error('[Color_FORM]', error);
        } finally {
            setLoading(false);
        }
    }
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>  
                        <Input disabled = {loading} placeholder="Color Name" className="w-full" {...field}/>
                        </FormControl>                        
                        <FormMessage/>
                    </FormItem>
                )}
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <Input disabled = {loading} placeholder="Color value" className="w-full" {...field}/>
                        <div
